...
-- CreateIndex
CREATE UNIQUE INDEX "votes_authorId_postId_key" ON "votes"("authorId", "postId");
...
-- AddForeignKey
ALTER TABLE "chats" ADD CONSTRAINT "chats_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "documents"("id") ON DELETE SET NULL ON UPDATE CASCADE;
